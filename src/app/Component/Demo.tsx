...
const Demo = () => {
    ...
    return (
        <>
            ...
            <header className={` bg-white dark:bg-gray-900 fixed w-full z-20`}>
                ...
                <Link href={"/"} className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <Link href={'/signup'} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Signin</Link>
                        </div>
                    </div>
                </div>
            </header>
