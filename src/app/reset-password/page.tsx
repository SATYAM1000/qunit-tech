...
const Page = () => {
	...
	const HandleSubmitOnRestPassword = async (
		...
		try {
			...
			if (passwords.cpassword != passwords.password) {
				...
				const { data }: AxiosResponse<ResponseType> = await axios.post(
					"/api/users/reset-password",
					{ newPassword: passwords.cpassword, token },
					{
						headers: {
						...
						<div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
							...
							<form className="mt-4 space-y-4 lg:mt-5 md:space-y-5">
								...
								<button
									...
									onClick={HandleSubmitOnRestPassword}>
									{isLoading ? (
