                            ...
                            <form className="space-y-4 md:space-y-6">
                                ...
                                <div className="flex max-md:flex-col max-md:gap-3" onChange={SetFields}>
                                    ...
                                    <div className="flex items-center me-4">
                                        ...
                                        <label htmlFor="category" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Profession/Developer</label>
                                    </div>
                                    <div className="flex items-center me-4">
                                        <input id="inline-2-radio" type="radio" value="Freelancer" name="category" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label htmlFor="category" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Freelancer</label>
                                    </div>
...
=======
export default Page;
>>>>>>> bfff010c6b954dae7f16c42b26f98ef9b1768f51
